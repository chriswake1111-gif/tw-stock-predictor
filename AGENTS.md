...
- M1B 與市場成交金額
- EPS 與估值區間
- Stage 1／2／3 分段部位的歷史回測模擬

現行 legacy 部位語意是 **20%／50%／100% 累積配置**，等同分段增加約 20%／30%／50%；不得將累積比例誤解為每一階段各自投入比例。Adaptive profile 只屬研究候選，未通過正式升格前不得取代 legacy 預設。
