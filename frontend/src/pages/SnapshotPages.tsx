...
export function SnapshotHistoryPage() {
  ...
  return <div className="page">
    <header className="workspace-heading"><div><span className="eyebrow">Immutable evidence records</span><h1>歷史快照</h1><p className="muted">只讀取後端保存的分析輸出，不在瀏覽器重建歷史。</p></div><Link className="secondary-button snapshot-compare-link" to="/snapshots/compare">比較兩份快照</Link></header>
