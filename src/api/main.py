...
from src.api.routes.v2_installed_data_operations import router as v2_installed_data_operations_router
...
def create_app(
    ...
    *,
    ...
    app.include_router(v2_installed_data_operations_router)
