...
from src.domain.technical_anchor import (
    AnchorPoint, AnchorRole, ManualAnchorSetRevision,
)
...
def test_fb04_trigger_requires_exact_effective_phase4_approval(tmp_path, monkeypatch):
    ...
    anchor = technical.ingest(ManualAnchorSetRevision(
        logical_anchor_set_id="2330-fb04", revision_number=1, symbol="2330",
        evidence_basis_rule_id="FB-04", anchors=(
            AnchorPoint(AnchorRole.ORIGIN, 100, "2026-01-01"),
            AnchorPoint(AnchorRole.SWING_END, 150, "2026-02-01"),
        ), available_at="2026-03-01T01:00:00Z", created_by="reviewer",
    ...
    triggers = (
        ...
        DeploymentTrigger(3, TriggerType.APPROVED_FB04_SCENARIO,
                          reference_id="scenario-fb04-2330", anchor_revision_id=anchor["id"],
                          approval_id=anchor_approval["approval_id"], rule_id="FB-04"),
    )
